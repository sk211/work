  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Seller Store<sup></sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{ url('/seller-product') }}">Manage Product:</a>
            <a class="collapse-item" href="{{ url('/seller-product-add') }}">Add Prudct</a>
            <a class="collapse-item" href="cards.html">Media Image </a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="utilities-color.html">Mange order </a>
            <a class="collapse-item" href="utilities-border.html">Mange review</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="#">Campaign Management</a>
            <a class="collapse-item" href="#">Bundles</a>
            <a class="collapse-item" href="#">Seller Voucher</a>
            <a class="collapse-item" href="#">FreeShipping</a>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="{{ url('/seller-information') }}">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="{{ url('/affiliate') }}">
          <i class="fas fa-fw fa-table"></i>
          <span>Affiliate Marketing</span></a>
      </li> 
           <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="{{ url('sellerPayment') }}">
          <i class="fas fa-fw fa-table"></i>
          <span>Finance</span></a>
      </li>
