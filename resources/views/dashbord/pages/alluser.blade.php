...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <button type="button" class="btn btn-primary btn-lg mb-5" onclick="window.location.href='./addNewuser.php'" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Add User +</button>
        <div class="row">
          ...
          <div class="col-md-10 offset-1 mt-5 pt-5">
            <table class="table">
              ...
              <tbody>
                <tr>
                  <th scope="row">sujan211</th>
                  <td><img src="../dist/img/user1-128x128.jpg" class="img-circle" width="70" alt=""></td>
                  <td>sujan majumde</td>
