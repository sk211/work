      ...
      <thead class="thead-dark ">
        ...
        <tbody>
          ...
          <tr>
            ...
            <th scope="row">{{ $v_allproduct->offer_price }}</th>
            <th scope="row">{{ $v_allproduct->product_code }}</th>
            <td>
            ...
            <td>
              <a href="{{ url('productAttr') }}/{{ $v_allproduct->id }}" class="btn btn-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i>
                 ...
                 <a href="{{ url('productEdit') }}/{{ $v_allproduct->id }}" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
